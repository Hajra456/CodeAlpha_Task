...
def main(interface, verbose=False):
    ...
    with open(logfile_name, 'w') as logfile:
        try:
            # Check if libpcap provider is available
            if conf.use_pcap:
                ...
                print("WARNING: No libpcap provider available! Packet capture will not be used.")
                # Implement an alternative solution here, such as using a different library
